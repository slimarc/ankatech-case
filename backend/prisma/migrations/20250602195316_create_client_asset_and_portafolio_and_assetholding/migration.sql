...
CREATE TABLE `portfolio_assets` (
    ...
    UNIQUE INDEX `portfolio_assets_portfolioId_assetId_key`(`portfolioId`, `assetId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `portfolio_assets` ADD CONSTRAINT `portfolio_assets_assetId_fkey` FOREIGN KEY (`assetId`) REFERENCES `assets`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
